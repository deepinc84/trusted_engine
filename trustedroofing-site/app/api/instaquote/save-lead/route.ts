...
export async function POST(request: Request) {
  ...
  try {
    ...
    try {
      ...
      legacyLeadError = error instanceof Error ? error.message : "Unknown legacy lead save error";
      console.error("instaquote legacy lead insert failed", error);
    }
    ...
    console.error("instaquote lead save failed", error);
