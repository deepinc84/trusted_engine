...
export const metadata = buildMetadata({
  title: "Vinyl Siding Calgary | Trusted",
  description: "Vinyl siding replacement for Calgary homes with practical pricing, exterior detailing, and instant online estimate options.",
  path: "/services/vinyl-siding"
});
...
export default async function VinylSidingPage() {
  ...
  return (
    <>
      ...
      <ServiceSchema serviceName="Vinyl Siding Replacement" serviceSlug="vinyl-siding" serviceType="Vinyl siding" />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(faqSchema) }} />

      <PageHero
        eyebrow="Vinyl siding Calgary"
        title="Vinyl Siding Replacement in Calgary"
