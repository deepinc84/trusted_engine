...
export const metadata = buildMetadata({
  title: "Eavestrough Calgary | Gutter Replacement Estimates",
  description: "Eavestrough and gutter replacement estimates for Calgary homes, including drainage, downspouts, roofline details, and instant online pricing.",
  path: "/services/eavestrough"
});
...
export default async function EavestroughPage() {
  ...
  return (
    <>
      ...
      <ServiceSchema serviceName="Eavestrough and Gutter Replacement" serviceSlug="eavestrough" serviceType="Gutter service" />
      <PageHero eyebrow="Eavestrough service" title="Eavestrough and Gutter Replacement in Calgary" description="Drainage details are easy to ignore until the water starts landing in the wrong place. Proper eavestrough sizing, slope, and downspout placement help protect siding, soffit, fascia, foundations, and walkways through Calgary rain and spring melt." actions={<Link href="/online-estimate" className="button">Get instant exterior estimate</Link>} />
      ...
      <CtaBand title="Need to know whether the problem is capacity, slope, or age?" body="Start with the quote tool, then we can confirm measurements and drainage layout on site." primaryLabel="Get instant exterior estimate" />
      <ServiceGeoPosts geoPosts={geoPosts} heading="Recent eavestrough and gutter jobs in Calgary" />
    </>
  );
}
