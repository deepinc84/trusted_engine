...
function buildBlogSchema() {
  ...
  return {
    ...
    url,
    image: [
      "https://unsplash.com/photos/a-man-riding-a-skateboard-on-top-of-a-roof-4XMHsy4Rvi8/download?force=true&w=1400",
      "/instant-quote.png",
      "https://images.unsplash.com/photo-1516156008625-3a9d6067fab5?w=1400&q=80&fit=crop",
      "https://unsplash.com/photos/a-roof-with-a-triangle-shaped-window-on-top-of-it-TnhkSNZPXd8/download?force=true&w=1400"
    ]
  };
}
  ...
  return (
    <>
      ...
      <section className={styles.section}>
        <div className={styles.shell}>
          <div className={styles.heroImageWrap}>
            <img
              src="https://unsplash.com/photos/a-man-riding-a-skateboard-on-top-of-a-roof-4XMHsy4Rvi8/download?force=true&w=1400"
      ...
      <div className={styles.shell}>
        <div style={{ borderRadius: "var(--r-lg)", overflow: "hidden", border: "1px solid var(--border-light)" }}>
          <img
            src="https://unsplash.com/photos/a-roof-with-a-triangle-shaped-window-on-top-of-it-TnhkSNZPXd8/download?force=true&w=1400"
