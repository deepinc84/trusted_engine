      ...
      <div className="homev3-container homev3-areas-layout">
        <div className="homev3-areas-intro">
          ...
          <p className="homev3-copy">
            Live project coverage across Calgary, with direct links into the neighborhoods where <BrandText descriptor="Roofing" /> is actively publishing work and pricing context.
          </p>
        </div>
