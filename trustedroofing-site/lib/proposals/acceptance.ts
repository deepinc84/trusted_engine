...
export type AcceptanceInput = { selectedTier?: string; selectedSoftScopeIds?: string[]; selectedVinylScopeIds?:string[]; selectedHardieScopeIds?:string[]; scopeColours?: Record<string, string>; colour?: string; signerLegalName: string; signerEmail: string; signatureType: "typed" | "drawn"; signatureData: string; authorityAccepted: boolean; termsAccepted: boolean };
