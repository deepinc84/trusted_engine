...
export type ProposalSection = { id?: string; type: "cover" | "summary" | "options" | "scope" | "eavestrough" | "downspouts" | "fascia" | "soffit" | "pricing" | "terms"; title: string; enabled: boolean; displayOrder: number; content: string };
